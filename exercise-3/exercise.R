...
employee.57 <- salaries[salaries$employee == "Employee 57",'salaries.2015' ]
...
got.biggest.raise <- salaries[salaries$raise == highest.raise,'employee']
...
got.largest.decrease <- salaries[salaries$raise == largest.decrease,'employee']
